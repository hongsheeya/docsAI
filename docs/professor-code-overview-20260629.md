...
코드 전체를 보면서 설명을 함께 확인하려면 `docs/code-explorer/index.html`을 엽니다. 이 HTML 문서는 왼쪽에 실제 원본 코드 전체를 보여주고, 오른쪽에 비전공자용 설명과 주요 함수/클래스 위치를 붙여 둔 코드 탐색 페이지입니다.

- 안내 문서: `docs/code-explorer/README.md`
